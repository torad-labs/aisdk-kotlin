...
internal class TestToolLoopAgent<TContext, TOutput>(
    ...
    onStart: (suspend AgentEvent.Started.() -> Unit)? = null,
    onStepStart: (suspend AgentEvent.StepStarted.() -> Unit)? = null,
    onStepFinish: (suspend AgentEvent.StepFinished.() -> Unit)? = null,
    onFinish: (suspend AgentEvent.Finished.() -> Unit)? = null,
    onError: (suspend AgentEvent.Errored.() -> Unit)? = null,
    onChunk: (suspend AgentEvent.Chunk.() -> Unit)? = null,
    onAbort: (suspend AgentEvent.Aborted.() -> Unit)? = null,
    experimental_onToolCallStart: (suspend AgentEvent.ToolCallStarted.() -> Unit)? = null,
    experimental_onToolCallFinish: (suspend AgentEvent.ToolCallFinished.() -> Unit)? = null,
