...
internal object AwsSigV4 {
    fun awsSigV4SignedHeaders(
        ...
        val payloadHash = CryptoPrimitives.sha256Hex(body.encodeToByteArray())
    ...
    fun currentAwsAmzDate(clock: Clock = Clock.System): String {
    ...
    private fun awsSigV4SigningKey(secretAccessKey: String, date: String, region: String, service: String): ByteArray {
        val dateKey = CryptoPrimitives.hmacSha256("AWS4$secretAccessKey".encodeToByteArray(), date.encodeToByteArray())
        val dateRegionKey = CryptoPrimitives.hmacSha256(dateKey, region.encodeToByteArray())
        val dateRegionServiceKey = CryptoPrimitives.hmacSha256(dateRegionKey, service.encodeToByteArray())
        return CryptoPrimitives.hmacSha256(dateRegionServiceKey, "aws4_request".encodeToByteArray())
    }
}
