...
/**
 * Pure-Kotlin SHA-256 used by the MCP OAuth PKCE flow (S256 code challenge).
 * Grouped into an object so the implementation is not a loose top-level helper.
 */
internal object McpSha256 {
