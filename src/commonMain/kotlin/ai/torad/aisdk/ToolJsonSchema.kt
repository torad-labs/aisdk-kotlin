 ...
 * state, safe to call eagerly. Consumed by `ToolSet.descriptors` via
 * [ToolJsonSchema.jsonSchemaFor].
 */
internal object ToolJsonSchema {
    fun jsonSchemaFor(tool: Tool<*, *, *>): String {
