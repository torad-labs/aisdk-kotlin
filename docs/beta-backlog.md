...
| BL-031 | Anthropic `max_tokens` not clamped to model ceiling → 400 | High | Recommended | CONFIRMED | OPEN |
| BL-032 | Anthropic sends sampling params to models that reject them (incl. `claude-opus-4-8`) | High | Recommended | CONFIRMED | OPEN |
