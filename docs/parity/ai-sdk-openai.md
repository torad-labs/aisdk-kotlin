...
- Version: 3.0.67
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.196/packages/openai`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/openai/src/index.ts` | 20 |
| `./internal` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/openai/src/internal/index.ts` | 64 |
