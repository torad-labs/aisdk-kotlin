...
- Version: 3.0.71
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.204/packages/openai`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.204/packages/openai/src/index.ts` | 20 |
| `./internal` | `.reference/vercel-ai-sdk-ai-6.0.204/packages/openai/src/internal/index.ts` | 64 |
