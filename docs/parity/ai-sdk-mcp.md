...
- Version: 1.0.50
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.204/packages/mcp`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.204/packages/mcp/src/index.ts` | 27 |
| `./mcp-stdio` | `.reference/vercel-ai-sdk-ai-6.0.204/packages/mcp/src/tool/mcp-stdio/index.ts` | 2 |
