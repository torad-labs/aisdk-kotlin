...
- Version: 3.0.6
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.208/packages/codemod`
- Kotlin parity area: `:aisdk-codemod`
...
|---|---|---:|
| `bin:codemod` | `.reference/vercel-ai-sdk-ai-6.0.208/packages/codemod/src/bin/codemod.ts` | 0 |
