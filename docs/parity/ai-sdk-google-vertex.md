...
- Version: 4.0.142
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/index.ts` | 11 |
| `./edge` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/edge/index.ts` | 4 |
| `./anthropic` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/anthropic/index.ts` | 4 |
| `./anthropic/edge` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/anthropic/edge/index.ts` | 4 |
| `./maas` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/maas/index.ts` | 5 |
| `./maas/edge` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/maas/edge/index.ts` | 5 |
| `./xai` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/xai/index.ts` | 5 |
| `./xai/edge` | `.reference/vercel-ai-sdk-ai-6.0.196/packages/google-vertex/src/xai/edge/index.ts` | 5 |
