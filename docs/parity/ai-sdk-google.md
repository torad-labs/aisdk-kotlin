...
- Version: 3.0.82
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.204/packages/google`
- Kotlin parity area: `:aisdk-provider-google`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.204/packages/google/src/index.ts` | 20 |
| `./internal` | `.reference/vercel-ai-sdk-ai-6.0.204/packages/google/src/internal/index.ts` | 10 |
