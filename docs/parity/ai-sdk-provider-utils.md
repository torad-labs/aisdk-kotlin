...
- Version: 4.0.27
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.195/packages/provider-utils`
- Target Kotlin module: `:aisdk-provider-utils`
- Current parity status: in-progress: provider utility subset is currently folded into the root module

## Entrypoints

| Subpath | Source | Export count |
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.195/packages/provider-utils/src/index.ts` | 104 |
| `./test` | `.reference/vercel-ai-sdk-ai-6.0.195/packages/provider-utils/src/test/index.ts` | 7 |
