...
- Version: 3.0.85
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.208/packages/anthropic`
- Kotlin parity area: `:aisdk-provider-anthropic`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.208/packages/anthropic/src/index.ts` | 11 |
| `./internal` | `.reference/vercel-ai-sdk-ai-6.0.208/packages/anthropic/src/internal/index.ts` | 4 |
