...
- Version: 2.0.33
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.195/packages/deepgram`
- Target Kotlin module: `:aisdk-provider-deepgram`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.195/packages/deepgram/src/index.ts` | 10 |
