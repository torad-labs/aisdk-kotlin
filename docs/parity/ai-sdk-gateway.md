...
- Version: 3.0.133
- Upstream path: `.reference/vercel-ai-sdk-ai-6.0.208/packages/gateway`
...
|---|---|---:|
| `.` | `.reference/vercel-ai-sdk-ai-6.0.208/packages/gateway/src/index.ts` | 29 |
...
| `GatewayForbiddenError` | value | `src/errors/index.ts` | `.` |
